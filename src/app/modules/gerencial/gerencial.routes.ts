...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'locacoes', loadChildren: () => import('./modules/rent/rent.routes').then(m => m.routes) },
      { path: 'vendas', loadChildren: () => import('./modules/purchase/purchase.routes').then(m => m.routes) },
